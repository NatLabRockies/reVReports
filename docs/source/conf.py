...
project = "reVReports"
copyright = "2026, Alliance for Energy Innovation, LLC and Root Geospatial LLC"
author = "NLR: Paul Pinchuk"

pkg = os.path.dirname(os.path.abspath(os.path.dirname(__file__)))
pkg = os.path.dirname(pkg)
sys.path.append(pkg)

from reVReports._version import __version_tuple__ as v
...
htmlhelp_basename = "reVReportsdoc"
...
man_pages = [
    (master_doc, "reVReports", "reVReports Documentation", [author], 1)
]
...
def _skip_nparray_methods(name, obj):
    return name in {
        "flatten",
        "item",
        "transpose",
...
def _skip_member(app, what, name, obj, skip, options):
    if (
        ...
        or _skip_nparray_methods(name, obj)
    ):
        return True
    return None
...
napoleon_type_aliases = {
    ...
    "IntervalIndex": "~pandas.I1ntervalIndex",
    ...
    "pd.NaT": "~pandas.NaT",
    "geoplot.projections": ":ref:`Projections <geoplot:/api_reference.rst#projections>`",
}
